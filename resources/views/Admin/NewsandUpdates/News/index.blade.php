...
@section('content')
    <div class="container">
        <form method="POST" action="{{route('admin.newsandupdates.news.add')}}">
            @csrf
            <div class="row card p-5">
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        <label>Title</label>
                        @if(isset($news->title))
                            <input type="text" hidden="" name="id" value="{{$news->id}}"class="form-control">
                     ...
                     <div class="form-group">
                        <label>Description</label>
                         @if(isset($news->description))
                           <textarea id="myTextarea" name="description" value="{{$news->description}}" style="width: 100%;">{{$news->description}}</textarea>
                        @else
