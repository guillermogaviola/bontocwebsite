...
<br>
    <div class="row" style="padding:0px;">
        <div class="col-lg-12">
                ...
                <div class="row mb-3">
                <?php
                foreach($bontocattractions as $bontocattractionss){
                ?>
                <div class="col-lg-4 mb-3">
                    <div class="row">
                        <div class="col-lg-12">
                            <img src="../uploads/<?php echo $bontocattractionss->file; ?>" width="350px" height="200px">
                        </div>
                        <div class="col-lg-12">
                             <a href="#"><h5><?php echo $bontocattractionss->title; ?></h5></a>
                        </div>
                        <div class="col-lg-12">
                            <p style="text-align: justify;">
                                <?php
                                    $str = $bontocattractionss->description;
                                    if (strlen($str) > 30)
                                    {
